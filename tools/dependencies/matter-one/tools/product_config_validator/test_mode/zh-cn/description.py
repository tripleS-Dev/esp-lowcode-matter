...
test_mode_light.interval_time_ms.title = "Interval time (in seconds)"
test_mode_light.interval_time_ms.description = "Interval time (in seconds) between displaying various colors, defualt is 1000ms"
...
test_mode_light.g_time_s.title = "green time (in seconds)"
